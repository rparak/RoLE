...
from RoLE.Transformation.Core import Get_Translation_Matrix
#   PyBullet
#       ../PyBullet/Mechanism/Core
import PyBullet.Mechanism.Core
...
def main():
    ...
    PyBullet_Mechanism_Cls = PyBullet.Mechanism.Core.Mechanism_Cls(Mechanism_Str, f'{CONST_PROJECT_FOLDER}/URDFs/Mechanisms/{Mechanism_Str.Name}/{Mechanism_Str.Name}.urdf', 
