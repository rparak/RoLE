...
def main():
    """
    Description:
        A program to test the configuration space by generating a random point within a defined cuboid area.
    """
    ...
    while PyBullet_Robot_Cls.is_connected == True:
        ...
        T_rand = PyBullet_Robot_Cls.Generate_Random_T_EE(True)
