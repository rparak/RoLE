...
def main():
    ...
    counter = 0
    N = sum(1 for _ in open(f'{project_folder}/Data/Workspace/{Robot_Str.Name}/{CONST_FILE_NAME}.txt'))
    ...
    with open(f'{project_folder}/Data/Workspace/{Robot_Str.Name}/{CONST_FILE_NAME}.txt', 'r') as f:
        for line in f:
