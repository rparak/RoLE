...
def main():
    ...
    for _, file_i in enumerate([f'{file_path}/Method_Numerical_IK_{CONST_NIK_METHOD}_TCP',f'{file_path}/Method_Numerical_IK_{CONST_NIK_METHOD}_Absolute_Joint_Positions',
    ...
    print(f'[INFO] >> {file_path}/Method_Numerical_IK_{CONST_NIK_METHOD}_TCP.txt')
