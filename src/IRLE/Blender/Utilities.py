...
def Set_Camera_Properties(name: str, Camera_Parameters_Str: IRLE.Blender.Parameters.Camera.Camera_Parameters_Str):
    """
    Description:
...
def Attach_Viewpoints(viewpoint_name: str, Robot_Parameters_Str: IRLE.Parameters.Robot.Robot_Parameters_Str) -> None:
    """
    Decription:
