...
#   ../IRLE/Kinematics/Utilities/Forward_Kinematics
import IRLE.Kinematics.Utilities.Forward_Kinematics as Utilities
#   ../IRLE/Kinematics/Utilities/General
import IRLE.Kinematics.Utilities.General as General
#   ../IRLE/Transformation/Core
from IRLE.Transformation.Core import Homogeneous_Transformation_Matrix_Cls as HTM_Cls, Vector3_Cls
...
#   ../IRLE/Interpolation/Utilities
import IRLE.Interpolation.Utilities
...
def Inverse_Kinematics_Numerical(TCP_Position: tp.List[tp.List[float]], theta_0: tp.List[float], method: str, 
    ...
    try:
        ...
        for _, t_i in enumerate(t):
            ...
            p_i = IRLE.Interpolation.Utilities.Lerp('Explicit', p_0, p_1, t_i)
            q_i = IRLE.Interpolation.Utilities.Slerp('Quaternion', q_0, q_1, t_i)
