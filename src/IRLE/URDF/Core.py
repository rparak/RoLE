...
#   ../IRLE/URDF/Utilities
import IRLE.URDF.Utilities as Utilities
...
#   ../IRLE/Utilities/MOI
import IRLE.Utilities.MOI as MOI
...
class URDF_Generator_Cls(object):
  ...
  <link name="ee_link"/>'''
    ...
    def Generate(self) -> None:
        ...
        self.__Robot_Parameters_Str.T.Zero_Cfg = IRLE.Kinematics.Core.Get_Individual_Joint_Configuration(self.__Robot_Parameters_Str.Theta.Zero, 'Modified', 
