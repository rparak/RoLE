...
def Get_Physical_Properties(name: str) -> tp.Tuple[float]:
    ...
    return {
        ...
        'ABB_IRB_120_L_Ax': {'mass': [21.0, 4.0, 8.25, 3.45, 5.9, 2.95, 2.30, 1.55, 0.60], 
...
def __Configure_Base():
   pass

def __Configure_Core():
   pass

def __Configure_EE():
   pass

def __Configure_URDF(part: str, Robot_Str: Parameters.Robot_Parameters_Str):
    return {
...
def Generate_URDF(Robot_Str: Parameters.Robot_Parameters_Str, use_mesh: bool, is_external_axis: bool, file_path: str) -> None:
    """
    Description:
        ...
    ...
    Args:
        ...
        (3) is_exetrenal_axis [bool]: Is the external axis part of the robot or not. For example, a linear track
        (4) file_path [string]: The specified path where the file should be saved.
                                Note:
